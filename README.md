...
Zaleca się uruchamiać program w terminalu, który wspiera Unicode oraz kody ANSI w pełni. Przykładami takich terminalów na systemie Windows są (Git) Bash oraz Windows Terminal. W przypadku użycia terminalu, który nie wspiera Unicode i/lub kodów ANSI w pełni, program może działać niepoprawnie.
...
Dotarcie do celu powoduje [zwycięstwo](#zwycięstwo).  
